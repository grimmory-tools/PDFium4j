...
public final class AnnotBindings {
    ...
    public static final MethodHandle FPDFPage_GetAnnotCount = downcallCritical(
            "FPDFPage_GetAnnotCount",
            FunctionDescriptor.of(JAVA_INT, ADDRESS));

    /** Get annotation by index. Returns FPDF_ANNOTATION (must be closed). */
    public static final MethodHandle FPDFPage_GetAnnot = downcall(
            "FPDFPage_GetAnnot",
            FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_INT));

    /** Close an annotation handle. */
    public static final MethodHandle FPDFPage_CloseAnnot = downcall(
            "FPDFPage_CloseAnnot",
            FunctionDescriptor.ofVoid(ADDRESS));

    /** Get annotation subtype. Returns FPDF_ANNOTATION_SUBTYPE (int). */
    public static final MethodHandle FPDFAnnot_GetSubtype = downcallCritical(
            "FPDFAnnot_GetSubtype",
            FunctionDescriptor.of(JAVA_INT, ADDRESS));

    /**
     * Get annotation string value by key (UTF-16LE, double-call pattern).
     * Common keys: "Contents", "T" (author), "Subj" (subject), "M" (modification date).
     */
    public static final MethodHandle FPDFAnnot_GetStringValue = downcall(
    ...
    public static final MethodHandle FPDFAnnot_GetRect = downcall(
            "FPDFAnnot_GetRect",
