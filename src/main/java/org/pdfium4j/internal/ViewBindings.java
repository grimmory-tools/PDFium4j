...
public final class ViewBindings {
     ...
     * }</pre>
     */
    public static final StructLayout LIBRARY_CONFIG_LAYOUT = MemoryLayout.structLayout(
    ...
    public static final MethodHandle FPDF_InitLibraryWithConfig = downcall(
            "FPDF_InitLibraryWithConfig",
            FunctionDescriptor.ofVoid(ADDRESS));

    /** Destroy PDFium library. */
    public static final MethodHandle FPDF_DestroyLibrary = downcall(
            "FPDF_DestroyLibrary",
            FunctionDescriptor.ofVoid());

    /** Load PDF from file path. Returns FPDF_DOCUMENT (NULL on failure). */
    public static final MethodHandle FPDF_LoadDocument = downcall(
            "FPDF_LoadDocument",
            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS));

    /** Load PDF from memory buffer. Returns FPDF_DOCUMENT (NULL on failure). */
    public static final MethodHandle FPDF_LoadMemDocument = downcall(
            "FPDF_LoadMemDocument",
            FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_INT, ADDRESS));

    /** Close a document. */
    public static final MethodHandle FPDF_CloseDocument = downcall(
            "FPDF_CloseDocument",
            FunctionDescriptor.ofVoid(ADDRESS));

    /** Get last error code. */
    public static final MethodHandle FPDF_GetLastError = downcallCritical(
            "FPDF_GetLastError",
            FunctionDescriptor.of(JAVA_LONG));

    /** Get page count. */
    public static final MethodHandle FPDF_GetPageCount = downcallCritical(
            "FPDF_GetPageCount",
            FunctionDescriptor.of(JAVA_INT, ADDRESS));

    /**
     * Get page size by index without loading the page.
     * Returns non-zero on success, writing width/height to out params.
     */
    public static final MethodHandle FPDF_GetPageSizeByIndex = downcall(
            "FPDF_GetPageSizeByIndex",
            FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_INT, ADDRESS, ADDRESS));

    /** Load a page. Returns FPDF_PAGE (NULL on failure). */
    public static final MethodHandle FPDF_LoadPage = downcall(
            "FPDF_LoadPage",
            FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_INT));

    /** Close a page. */
    public static final MethodHandle FPDF_ClosePage = downcall(
            "FPDF_ClosePage",
            FunctionDescriptor.ofVoid(ADDRESS));

    /** Get page width in points (1 pt = 1/72 inch). */
    public static final MethodHandle FPDF_GetPageWidthF = downcallCritical(
            "FPDF_GetPageWidthF",
            FunctionDescriptor.of(JAVA_FLOAT, ADDRESS));

    /** Get page height in points. */
    public static final MethodHandle FPDF_GetPageHeightF = downcallCritical(
            "FPDF_GetPageHeightF",
            FunctionDescriptor.of(JAVA_FLOAT, ADDRESS));

    /** Render page to bitmap. */
    public static final MethodHandle FPDF_RenderPageBitmap = downcall(
