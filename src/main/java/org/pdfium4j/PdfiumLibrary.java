...
import org.pdfium4j.internal.NativeLoader;
 ...
 *
 * <p>PDFium requires a single call to {@code FPDF_InitLibraryWithConfig} before
 * any document operations, and {@code FPDF_DestroyLibrary} at shutdown.
 * This class handles both automatically.
 *
 * <p>Thread safety: initialization is synchronized. After init, independent
 * {@link PdfDocument} instances on separate threads are safe. A single
 * document/page handle must not be accessed concurrently.
 */
public final class PdfiumLibrary {
    ...
    /**
     * Ensure PDFium is initialized. Safe to call multiple times.
     * Called automatically by {@link PdfDocument#open} methods.
     */
