...
public final class DocBindings {
  ...
  /**
   * Get document metadata value by tag name. Double-call pattern: first call with NULL buffer
   * returns required size in bytes. Tags: "Title", "Author", "Subject", "Keywords", "Creator",
   * "Producer", "CreationDate", "ModDate". Returns UTF-16LE encoded string (byte count including
   * null terminator).
   */
  ...
  /**
   * Get the page label for a given page index (UTF-16LE, double-call pattern). Page labels are
   * logical labels like "i", "ii", "1", "2", "A-1". Returns byte count including null terminator,
   * or 0 if no label.
   */
  ...
  /**
   * Get first child bookmark. Pass NULL parent for root-level bookmarks. Returns FPDF_BOOKMARK
   * (NULL if none).
   */
  ...
  /**
   * Get bookmark title (UTF-16LE, double-call pattern). Returns byte count including null
   * terminator.
   */
