...
/**
 * Information about a single character on a PDF page, including its position, bounding box, and
 * font size.
 *
 * <p>All coordinates are in PDF page units (points, 1 pt = 1/72 inch). Origin is bottom-left of the
 * page.
 *
...
public record TextCharInfo(
    int charCode, double left, double bottom, double right, double top, double fontSize) {
  public TextCharInfo {
    left = sanitize(left);
